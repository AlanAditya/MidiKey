...
| **Provider Portal** – read-only view for verified professionals | `pages/ProviderPortal.tsx`, `ProviderHome.tsx` | Decrypts in the provider's browser, **verifies the patient's Ed25519 signature**, read-only, watermarked, print-blocked, auto-wipes on expiry. |
